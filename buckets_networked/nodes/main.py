from aioble import advertise, Characteristic, Service
...
GAME_SERVICE_UUID = UUID("00001800-0000-1000-8000-00805f9b34fb")
TEAM_CHAR_UUID = UUID("00002a00-0000-1000-8000-00805f9b34fb")

game_service = Service(GAME_SERVICE_UUID)
team_char = Characteristic(
    game_service,
    TEAM_CHAR_UUID,
    read=True,
    notify=True,
...
async def bt_connecting():
    """Async function for updating bluetooth"""
    while True:
